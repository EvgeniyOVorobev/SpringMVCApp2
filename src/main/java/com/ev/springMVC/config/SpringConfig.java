...
@Configuration
@ComponentScan("com.ev.springMVC")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("com.ev.springMVC.repositories")
...
//        sessionFactory.setPackagesToScan("com.ev.springMVC.Models");
...
public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    em.setPackagesToScan("com.ev.springMVC.Models");
